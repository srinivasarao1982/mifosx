...
@Entity
@Table(name = "m_equifax_response") 
public class EquifaxResponse extends AbstractAuditableCustom<AppUser, Long>{
    ...
    public static EquifaxResponse create(Long centerId, String requestUUID, String serviceName, String channelId, String corId,
			String creditApproved, String reason, String eligibleLoanAmount, String json,Long clientId){
    	return new EquifaxResponse(centerId,requestUUID,serviceName,channelId,corId,creditApproved,reason,eligibleLoanAmount,json,clientId);
    }

	public EquifaxResponse(Long centerId, String requestUUID, String serviceName, String channelId, String corId,
			String creditApproved, String reason, String eligibleLoanAmount, String json,Long clientId) {
		super();
