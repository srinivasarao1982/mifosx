...
public class UpdateTaskCommandHandler implements NewCommandSourceHandler {
	    ...
	    @Autowired
	    public UpdateTaskCommandHandler(final TaskWriteplatformService taskWriteplatformService) {
	    ...
	    public CommandProcessingResult processCommand(final JsonCommand command) {
	        ...
	        return this.taskWriteplatformService.updateTask(command.entityId(), command);
	    }
	}
