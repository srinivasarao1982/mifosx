...
public class CreditBureauValidationError extends AbstractAuditableCustom<AppUser, Long> {
    ...
    public static CreditBureauValidationError create (final Long centerId,final String barcodeNo,final String externalId, final String isRenewalLoan,
			...
			final String operatingRegionName, final Date dateOfBirth,final String branchCode,final String branchName,final String json,final Long clientId){
    
    	return new CreditBureauValidationError( centerId,  barcodeNo,  externalId,  isRenewalLoan,
	...
	public CreditBureauValidationError(Long centerId, String barcodeNo, String externalId, String isRenewalLoan,
