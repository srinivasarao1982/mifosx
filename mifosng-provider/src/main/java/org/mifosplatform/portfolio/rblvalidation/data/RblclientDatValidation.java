...
public class RblclientDatValidation {
	...
	public RblclientDatValidation(String externalId, String externalCenterId, String title, String customerName,
			...
			String nataonality, String relegion, String motherTounge, String branchCode, String operatingregionCode,
			String aadharNo, String pensioncardNo, String rationCardNo, String voterId, String health,
			...
			String bankbranchName, Integer renewalFl,String panno,String barcodeNumber) {
		super();
		...
		this.cardIssueFlag = cardIssueFlag;
	...
	public void setExternalCenterId(String externalCenterId) {
		this.externalCenterId = externalCenterId;
	}
	...
	public String getNataonality() {
		return nataonality;
	}
	public void setNataonality(String nataonality) {
		this.nataonality = nataonality;
	}
	...
	public Integer getCardIssueFlag() {
		return cardIssueFlag;
	}
	public void setCardIssueFlag(Integer cardIssueFlag) {
		this.cardIssueFlag = cardIssueFlag;
	}
